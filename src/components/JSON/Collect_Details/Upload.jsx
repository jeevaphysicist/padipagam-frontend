...
let output = fetch(`${API}/json/uploadcontent`,options);
   ...
   <Fragment>
      ...
      <div className='row pt-2  mx-auto text-start container' >
         ...
         <div className='row  mx-auto text-start' style={{color:"white"}}>
           <div className='col-12 col-md-1 col-lg-3 col-xl-3'></div>
           ...
           <div className='col-12 col-md-3 col-lg-2 col-xl-2'><span id="menu-row"><i className="bi bi-lock-fill" ></i>&nbsp;&nbsp;Lock Account</span></div>
           <div className='col-12 col-md-1 col-lg-1 col-xl-1'></div>
         </div>

         <div className='row pt-2 '>
           <div className='col-12 '>
           <div id='main' style={{height:"79vh",color:"white"}} >
             ...
             <div className='text-center my-3'>{topic}</div>
                <Collectdetails FinishHandler={FinishHandler} topic={topic} section={Section} />
             </div>
           </div>
           </div>     
        </div>
