...
export default function Index() {
   ...
   const loginHandler =(e)=>{
        ...
        fetch(`${API}/JsonAuth/login`,options)
             .then(res=>res.json())
             .then(result=>{
                  //   console.log(result);
                   if(result.isloggedin){
                      setLoginerr('');
                      sessionStorage.setItem('JSONUser',JSON.stringify(result.data));
         ...
         <div className='row pt-5 '>
           ...
           <div className='col-12 col-md-4 col-lg-6 col-xl-6 text-center '>
                ...
                <form className='json-login-box mx-auto' onSubmit={(e)=>loginHandler(e)}>
                  ...
                  <div className="heading pt-2" style={{fontWeight:"bolder",color:"red"}}>{loginerr}</div>
                  <div className="input-group mb-3 p-3 ">
                   <span  style={{backgroundColor:"transparent",color:'white'}} className="input-group-text" id="basic-addon1"><i className="bi bi-envelope-at-fill"></i></span>
                   <input  style={{backgroundColor:"transparent",color:'white'}} type="Email" required className="form-control" placeholder="Email" aria-label="Email" aria-describedby="basic-addon1" onChange={(e)=>setEmail(e.target.value)} />
                 </div>
                 ...
                 <div className="input-group mb-3 p-3 " style={{backgroundColor:"transparent"}}>
                   ...
                   <input  style={{backgroundColor:"transparent",color:'white'}} type="Password" required className="form-control" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1"  onChange={(e)=>setPassword(e.target.value)} />
                 </div>
